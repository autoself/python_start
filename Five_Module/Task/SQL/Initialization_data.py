...
record_data_01 = model.Record(start_time='2017-10-01',end_time='2017-10-07',student_id='1',grades_id='1',course_id='2',day='4',status='1')
record_data_02 = model.Record(start_time='2017-10-01',end_time='2017-10-07',student_id='2',grades_id='1',course_id='2',day='5',status='1')
record_data_03 = model.Record(start_time='2017-11-12',end_time='2017-11-27',student_id='2',grades_id='3',course_id='4',day='10',status='1')


Session.add_all([teacher_data_01,teacher_data_02,grades_data_01,grades_data_02,grades_data_03,course_data_01,course_data_02,course_data_03,              course_data_04,student_data_01,student_data_02,record_data_01,record_data_02,record_data_03 ])
